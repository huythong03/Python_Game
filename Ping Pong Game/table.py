...
class Table:
    ...
    def _ball_hit(self):
        #Nếu bóng không được đánh bởi một cầu thủ và đi qua các mặt bàn
    ...
    def player_move(self):
        ...
        #Để điều khiển đối thủ BOT
        self._bot_opponet()

        #Để điều khiển người chơi
        if keys[pygame.K_UP]:
